...
class Batch(object):
    ...
    def __init__(self, data=None, device=None, is_test=True):
...
def load_dataset(args, corpus_type, shuffle):
    ...
    if corpus_type == "test":
        pts = sorted(glob.glob('intern_task5/task11/ext/data/bert_data/test' + '/' + corpus_type + '.[0-9]*.pt'))        
    elif corpus_type == "valid":
        pts = sorted(glob.glob('intern_task5/task11/ext/data/bert_data/valid_ext' + '/' + corpus_type + '.[0-9]*.pt'))
