...
if __name__ == '__main__':
    ...
    # python main.py -task train -target_summary_sent abs -visible_gpus 0 -train_from 1209_1236/model_step_7000.pt 
        ...
        param2 = " -ext_dropout 0.1 -lr 2e-3 -batch_size 2000 -train_steps 28000 -accum_count 2 -use_interval true -warmup_steps 3000 -max_pos 512"
    ...
    # python main.py -task test -test_from 1209_1236/model_step_7000.pt -visible_gpus 0
        ...
        os.system(f"""\
            ...
            -bert_data_path {BERT_DATA_DIR}/test_ext \
    ...
    # python main.py -task rouge --gold_file /path/to/your/gold/file.gold --candidate_file /path/to/your/candidate/file.candidate
        ...
        os.system(f"""\
            python rouge_scores_csv.py --gold_file {args.gold_file} --candidate_file {args.candidate_file}
        """)
